...
function LoginForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('https://api-proyecto-sena-connect-ar-production.up.railway.app/auth/login', {
      ...
      console.error('Error al iniciar sesión:', error.message, correo , contrasena);
        ...
        <Box>
          ...
          <Box component="form" onSubmit={handleSubmit}>
            ...
            <Grid container>
              ...
              <Grid item>
                <Link to={"/registrar"}>No tienes una cuenta ¿Desea registrarse?</Link>
              </Grid>
            </Grid>
          </Box>
        </Box>
